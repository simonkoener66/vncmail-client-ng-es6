let mdCalendarHelperService = (dateFilter, moment, calendarConfig)=> {
  let helperService = {
...
mdCalendarHelperService.$inject = ['dateFilter', 'moment', 'calendarConfig'];

export default mdCalendarHelperService;
